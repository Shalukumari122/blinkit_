...
from blinkit_.items import BlinkitItem1
...
db = pymysql.connect(
    ...
    user='root',  # e.g., 'root'
    password='actowiz',
    database='zepto'  # e.g., 'test_db'
)
cursor = db.cursor()

# Create a table if it doesn't exist
plQuery = ''' CREATE TABLE IF NOT EXISTS blinkit_lat_long_comp(
...
df_pincodes = pd.read_excel('C:\Users\shalu.kumari\PycharmProjects\pythonProject\blinkit\input\blinkit_comp.xlsx')
        ...
        for index, predictions in enumerate(predictions_list):
            ...
            if placeid:
                ...
                if data3['serviceable']:
                    ...
                    insert_query = "INSERT INTO blinkit_lat_long_comp(" + column_name + ")" + 'VALUES' + "(" + str_values + ")"
